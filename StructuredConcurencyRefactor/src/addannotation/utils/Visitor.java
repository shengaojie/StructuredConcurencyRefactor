...
public class Visitor {
	...
	public static void collectTargetNode(MethodDeclaration cuu, CompilationUnit root) {

		VerifyIfMatched verifyIfMatched = new VerifyIfMatched();
		...
		// System.out.println("refactorNode submiAndget is:" +
		// refactorNode.stmtbeSubAndGet);
